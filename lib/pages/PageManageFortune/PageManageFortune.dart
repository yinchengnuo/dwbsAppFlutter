...
class _PageManageFortuneState extends State<PageManageFortune> {
  ...
  final _lineColor = Color(int.parse('A213C8', radix: 16)).withAlpha(255); // 图表内容颜色
  final _backgroundColor = Color(int.parse('F4E4F9', radix: 16)).withAlpha(255); // 图表背景颜色
          ...
          children: <Widget>[
            ...
            Wrap(
              children: <Widget>[
                ...
                IndexKingkongItem(src: 'lib/images/home/indexincome-shop.png', title: '零售录单', route: '/test'),
              ],
            )
          ],
        ),
