...
class PageRewardIn extends StatefulWidget {
  PageRewardIn({Key key}) : super(key: key);

  @override
  _PageRewardInState createState() => _PageRewardInState();
}

class _PageRewardInState extends State<PageRewardIn> {
  Map _data;
  bool _loading = false;
  ...
  void _request() {
    ...
    apiRewardDetail({'type': 1}).then((status) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Loading(
      ...
      child: Scaffold(
        appBar: Ycn.appBar(context, title: '奖励收入'),
